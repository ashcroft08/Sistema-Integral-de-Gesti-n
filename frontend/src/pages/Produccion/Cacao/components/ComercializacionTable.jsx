            ...
            <table className="w-full text-sm text-left border-collapse whitespace-nowrap">
                ...
                <tbody>
                    {loading ? (
                        ...
                        lotes.map((l) => {
                            const com = l.LoteComercializacionOrgs?.[0] || null;
                            const hasCom = !!com;
                            const isSeco = l.es_seco;

                            return (
                                <tr
                                    key={l.id_control_lote_org}
                                            ...
                                            {hasCom && parseFloat(com.porcentaje_perdida) > 3 && (
                                                <div className="relative inline-block text-left">
                                                    <button 
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                            if (activeTooltipId === l.id_control_lote_org) {
                                                                setActiveTooltipId(null);
                                                                setTooltipCoords(null);
                                                            } else {
                                                                const rect = e.currentTarget.getBoundingClientRect();
                                                                setActiveTooltipId(l.id_control_lote_org);
                                                                setTooltipCoords({
...
export default ComercializacionTable;
