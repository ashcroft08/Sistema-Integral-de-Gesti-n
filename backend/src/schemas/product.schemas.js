...
export const CreateProductSchema = z.object({
    ...
    // Añadir código de producto opcional
    codigo_producto: z.string()
        .trim()
        .max(50, "El código de producto no puede exceder 50 caracteres")
        .optional()
        .nullable() // O .nullish() si prefieres undefined
        .transform(val => val === '' ? null : val), // Transformar cadena vacía a null
});
...
// ... resto del código (ChangeProductStatusSchema, ProductIdSchema)
